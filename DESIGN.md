...
- **Pro Violet** (#6b21a8 — purple-800) on **Pro Violet Wash** (#f3e8ff — purple-100): The *only* place a second identity hue is allowed — Pro/upgrade affordances. Keeps "upgrade" visually distinct from "act" (blue), so the upsell never masquerades as a core action.
